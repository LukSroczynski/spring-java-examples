...
public class FunctionalProgrammingJava {
    ...
    public void SimpleStream_CountWordsWithSixCharacters() {
        ...
        List<String> dogs = Arrays.asList("XX", "123456", "XYZXYZ", "qwerty", "1234", "12345");

        int dogsCounter = dogs.stream()
    ...
    public void calculateAverage() {
        ...
        List<Integer> score = Arrays.asList(5, 4, 3, 2);

        double result =score.stream().collect(Collectors.averagingDouble(s -> s));

        assertEquals(result, 3.5, 0);
